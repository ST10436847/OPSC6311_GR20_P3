...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `categories` (`id`,`username`,`name`) VALUES (nullif(?, 0),?,?)";
      }
    ...
    this.__updateAdapterOfCategory = new EntityDeletionOrUpdateAdapter<Category>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`username` = ?,`name` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object getCategoriesByUser(final String username,
      final Continuation<? super List<Category>> $completion) {
    final String _sql = "SELECT * FROM categories WHERE username = ? ORDER BY name ASC";
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Category(_tmpId,_tmpUsername,_tmpName);
            _result.add(_item);
          }
          return _result;
        } finally {
